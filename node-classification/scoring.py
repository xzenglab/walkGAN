...
def main():
  ...
  parser.add_argument("--emb", default=r'..\save\blogcatalog\blogcatalog(deepwalk).embeddings',help='Embeddings file')
#  parser.add_argument("--emb", required=True, default='blogcatalog\CA-GrQc_pre_train.emb', help='Embeddings file')
  parser.add_argument("--network",default=r'blogcatalog\blogcatalog.mat',
